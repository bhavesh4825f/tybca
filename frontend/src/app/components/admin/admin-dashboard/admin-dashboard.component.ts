    ...
    <div class="dashboard-container">
      <nav class="sidebar">
        ...
        <ul class="nav-menu">
          ...
          <li>
            <a routerLink="/admin/applications" routerLinkActive="active">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
          ...
          <li>
            <a routerLink="/admin/contact-queries" routerLinkActive="active">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path d="M2 3C2 2.44772 2.44772 2 3 2H17C17.5523 2 18 2.44772 18 3V11C18 11.5523 17.5523 12 17 12H11L7 16V12H3C2.44772 12 2 11.5523 2 11V3Z" fill="currentColor"/>
                <path d="M6 6H14M6 8H10" stroke="white" stroke-width="1.5" stroke-linecap="round"/>
              </svg>
